...
<template>
  <div data-tauri-drag-region class="flex h-16 shrink-0 items-center gap-3.5 px-5.5">
    <IconSearch class="size-5.5 shrink-0 text-muted-foreground/80 transition-colors" />
